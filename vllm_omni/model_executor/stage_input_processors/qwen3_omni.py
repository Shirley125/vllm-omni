...
def thinker2talker_async_chunk(
    ...
    """
    Pooling version. Process thinker outputs to create talker inputs.
    ...
    """
    print(f"cwj thinker2talker_async_chunk")
...
def talker2code2wav_async_chunk(
    ...
    Pooling version.
    """
    print("cwj talker2code2wav_async_chunk")
